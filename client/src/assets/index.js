...
import nft from "./background/NFT.png";
...
export const gameRules = [
  "Thẻ có cùng điểm phòng thủ và tấn công sẽ triệt tiêu lẫn nhau.",
  "Điểm tấn công từ thẻ tấn công sẽ trừ điểm sức khỏe của người chơi đối phương.",
  "Nếu Player 1 không phòng thủ, sức khỏe của họ sẽ bị trừ bởi đòn tấn công của Player 2.",
  "Nếu Player 1 phòng thủ thì Player 2 tấn công bằng Player 2 tấn công - Player 1 phòng thủ.",
  "Nếu một người chơi phòng thủ, họ sẽ nạp lại 3 Mana",
  "Nếu một người chơi tấn công, họ tiêu tốn 3 Mana",
];
